...
namespace RevisionPlanner.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,SubjectName,Difficulty")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,SubjectName,Difficulty")] Subject subject)
        {
            if (id != subject.Id)
            {
                return NotFound();
