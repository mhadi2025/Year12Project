...
namespace RevisionPlanner.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(RevisionPlannerDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,FirstName,LastName,EmailId,EmailPassword,Year")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
